...
<body>
                ...
                if(mysqli_num_rows($results)>0)
                {
                    ...
                    while($row = mysqli_fetch_array($results))
                    {
                        ...
                        ?>
                            ...
                            <td><a href="/ClinicManagement/pages/pt-history.php?app_id=<?php echo $row['app_id'];?>&patient_id=<?php echo $row['patient_id'];?>&doc_id=<?php echo $row['doc_id'];?>"><?php echo $row['app_id'];?></a></td>
                        <?php
                        ...
                        ?>
                            <form name="del-app" ac
                            <td><input type='submit' name='app-del' value='delete'></td>";
    ...
    <form class="b-app" target="_blank" onclick="window.open('pages/appointments.php','newwindow','width=700,height=800'); return false;">
